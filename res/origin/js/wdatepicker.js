...
(function() {
    ...
    A = $.$dpPath || J();
    if ($.$wdate) K(A + "skin/wdataPicker.css");
    V = Y;
    ...
    function I(G, _) {
        ...
        function E(K, J) {
            var I = V[N].domain,
                F = false,
                G = "<iframe hideFocus=true width=9 height=7 frameborder=0 border=0 class=\"cp_WdatePicker\" scrolling=no src=\"about:blank\"></iframe>";
            K.innerHTML = G;
            var _ = $.$langList,
                D = $.$skinList,
                H;
